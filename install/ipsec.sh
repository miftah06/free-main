...
wget -O /usr/bin/add-l2tp https://geovpn.github.io/free/ipsec/add-l2tp.sh && chmod +x /usr/bin/add-l2tp
wget -O /usr/bin/del-l2tp https://geovpn.github.io/free/ipsec/del-l2tp.sh && chmod +x /usr/bin/del-l2tp
wget -O /usr/bin/add-pptp https://geovpn.github.io/free/ipsec/add-pptp.sh && chmod +x /usr/bin/add-pptp
wget -O /usr/bin/del-pptp https://geovpn.github.io/free/ipsec/del-pptp.sh && chmod +x /usr/bin/del-pptp
wget -O /usr/bin/renew-pptp https://geovpn.github.io/free/ipsec/renew-pptp.sh && chmod +x /usr/bin/renew-pptp
wget -O /usr/bin/renew-l2tp https://geovpn.github.io/free/ipsec/renew-l2tp.sh && chmod +x /usr/bin/renew-l2tp
wget -O /usr/bin/cek-pptp https://geovpn.github.io/free/ipsec/cek-pptp.sh && chmod +x /usr/bin/cek-pptp
