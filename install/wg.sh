...
echo -e "${Info} Wireguard VPS AutoScript by anu"
...
# Tambahan
cd /usr/bin
wget -O add-wg "https://geovpn.github.io/free/wireguard/add-wg.sh"
wget -O del-wg "https://geovpn.github.io/free/wireguard/del-wg.sh"
wget -O cek-wg "https://geovpn.github.io/free/wireguard/cek-wg.sh"
wget -O renew-wg "https://geovpn.github.io/free/wireguard/renew-wg.sh"
chmod +x add-wg
chmod +x del-wg
chmod +x cek-wg
chmod +x renew-wg
